...
```{r}
# load in almond anomaly function
source(here("almond_only_juliet.R"))
```

# you should be able to delete this code chunk now Juliet! (I loaded/sourced function above)
